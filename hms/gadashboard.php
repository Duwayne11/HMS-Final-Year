...
<html lang="en">
	...
	<body>
			...
			<nav>
					<ul class="menueHcp">
						<li><a onclick="showHideForm()">Update User Profile </a></li>
						...
						<div id="banner">
							<h4>Welcome <?php echo $_SESSION['adminusername']; ?> <?php $_SESSION['adminpass']; ?> </h4>   	
	...
	<div id="iconContainer">
			...
			<div class="iconRow">
					...
					<div class="iconPlacing">
						<div id="adminIcon" onclick="document.getElementById('modal-wrapper').style.display='block'">
							<div class="multi-borderLogin">
								<a href ="gaPerscriptions.php" id=""> <img src="./pictures/perscriptions.png" alt="Doctor" style="width:158px" style="height: 126px" onmouseover="ShowDoctor()" onmouseout="ShowDoctor()""></a>
...
<!-- Beginning of user update section -->
		<form  action="gadashboard.php" method="post" id="updateForm">
